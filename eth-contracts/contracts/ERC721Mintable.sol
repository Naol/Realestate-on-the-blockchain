...
contract Ownable {
    ...
    // modifier onlyOwner() {
    //     require(msg.sender == _owner, 'Called by an account other than the owner');
    //     _;
    // }
    ...
    //     // TO/DO add functionality to transfer control of the contract to a newOwner.
...
//  TO/DO's: Create a Pausable contract that inherits from the Ownable contract
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // TO/DO: create private mapping of tokenId's to token uri's called '_tokenURIs'
